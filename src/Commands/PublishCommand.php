...
namespace mauijay\boilerplate\Commands;
...
class PublishCommand extends BaseCommand
{
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace mauijay\boilerplate\Config', 'namespace Config', $content);
    ...
    protected function publishMigration()
    {
        ...
        foreach ($map as $file) {
            ...
            $content = str_replace('namespace mauijay\boilerplate\Database\Migrations', 'namespace '.APP_NAMESPACE.'\Database\Migrations', $content);
